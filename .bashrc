...
alias eca='qemu-system-x86_64 -m 8192 -usbdevice tablet -smp 12 -nic user,id=vmnic,hostfwd=tcp:127.0.0.1:60022-:22 -vga virtio -device virtio-blk-pci,drive=hd0 -drive if=none,id=hd0,file=/home/miyako/qemu/ECA/ECA2021_2022-disk001.img,format=raw -enable-kvm'
